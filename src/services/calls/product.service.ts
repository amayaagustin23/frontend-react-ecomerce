...
export const getAllVariantColors = () => api.get(PRODUCT_ENDPOINTS.GET_ALL_COLORS);

export const getAllVariantSizes = () => api.get(PRODUCT_ENDPOINTS.GET_ALL_SIZES);

export const getAllVariantGenders = () => api.get(PRODUCT_ENDPOINTS.GET_ALL_GENDERS);

export const getAllFavorites = () => api.get(PRODUCT_ENDPOINTS.GET_ALL_FAVORITES);
